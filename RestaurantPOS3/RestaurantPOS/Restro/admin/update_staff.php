...
if (isset($_POST['UpdateStaff'])) {
  ...
  if (empty($_POST["staff_number"]) || empty($_POST["staff_name"]) || empty($_POST['staff_email']) || empty($_POST['staff_password'])) {
    ...
    $staff_password = sha1(md5($_POST['staff_password'])); // CON ENCRIPTADO
                ...
                <form method="POST">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input  name="staff_email" class="form-control" value="<?php echo $staff->staff_email; ?>">
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      <input type="submit" name="UpdateStaff" value="ACTUALIZAR EMPLEADO" class="btn btn-success" value="">
                    </div>
                  </div>
                </form>
              </div>
