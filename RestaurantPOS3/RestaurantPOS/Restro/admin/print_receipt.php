...
while ($order = $res->fetch_object()) {
	...
	$total = ($order->prod_price*1.18)*($order->prod_qty);
                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>RESTAURANTE EL MARKETCITO</strong>                
                                <br>
                                Av Ing Roberto Pastoriza 204, Santo Domingo
                                <br>
                                (829) 538-0000
                            </address>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                            <p>
                                <em>FECHA FACTURA: <?php echo date('d/M/Y g:i', strtotime($order->created_at)); ?></em>
                            </p>
                            <p>
                                <em class="text-success">FACTURA NO. #: <?php echo $order->order_code; ?></em>
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">$<?php echo $subtotal; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <p>
                                            <strong>$<?php echo $subtotal*0.18; ?></strong>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
