...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2023 a las 00:49:24
...
('78b7b30426ea', 'juan', '80000000', 'juan@gmail.con', '1f82ea75c5cc526729e2d581aeb3aeccfef4407e', '2023-07-30 19:51:46.797403'),
...
--
-- Estructura de tabla para la tabla `_reservacion`
--

CREATE TABLE `_reservacion` (
  ...
  `reservacion_tel` int(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Indices de la tabla `_reservacion`
--
ALTER TABLE `_reservacion`
...
--
-- AUTO_INCREMENT de la tabla `_reservacion`
--
ALTER TABLE `_reservacion`
