...
function planyo_output_resource_list() {
  ...
  echo planyo_get_contents("https://www.planyo.com/rest/planyo-reservations.php", planyo_add_other_params($params));
...
function planyo_setup() {
  ...
  if (!$planyo_always_use_ajax) {
    ...
    if (!$planyo_feedback_url)
      $planyo_feedback_url = "https://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
